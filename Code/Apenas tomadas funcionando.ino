...
int pinos_tensao[num_tomadas] = {35, 34, 0, 0};
int pinos_corrente[num_tomadas] = {26, 27, 32, 33};
int pinos_rele[num_tomadas] = {25, 16, 4, 15};
...
void setup() {
  ...
  sensor_corrente_1.autoCalibrate();
  sensor_corrente_2.autoCalibrate();
  sensor_corrente_3.autoCalibrate();
  sensor_corrente_4.autoCalibrate();
